...
export const About: React.FC = () => {
  return (
    <section className="relative mb-8 flex flex-col gap-3 overflow-hidden ">
      ...
      <div className="px-6 text-justify text-[20px] ">
        <b className="inline text-primary-200">Lucas Hoelzle</b> dolor sit amet
